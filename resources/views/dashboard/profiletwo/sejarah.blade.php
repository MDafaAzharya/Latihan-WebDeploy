...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Sejarah </h4>
    ...
    <section>
        <div class="card">
            ...
            action="{{ route('sejarah.data-sejarah-update') }}" method="POST">
            @csrf
            @foreach($sejarah as $key => $data)
