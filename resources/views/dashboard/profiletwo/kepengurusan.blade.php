...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Kepengurusan </h4>
    ...
    <section>
        <div class="card">
            ...
            action="{{ route('kepengurusan.data-kepengurusan-update') }}" method="POST">
            @csrf
            @foreach($kepengurusan as $key => $data)
