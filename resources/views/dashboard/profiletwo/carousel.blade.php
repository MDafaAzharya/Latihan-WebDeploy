...
@section('content')
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"> Dashboard /</span> Carousel</h4>
    <div class="card mb-3">
        <div class="p-2">
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="addNewCCForm" class="row g-3" method="post" action="{{ route('carousel.data-carousel-register') }}"
    ...
    <script>
        @if (session()->has('success'))
            $(function() {
                ...
                setTimeout(
                    "location.href='{{ route('carousel_admin') }}'",
                    1000);
            });
        @endif
    </script>
        ...
        $('.deleteprogram').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('dashboard/carousel_admin/data-carousel-delete') }}/" + id,
                        type: "get",
                        data: {
                            _method: 'DELETE',
                            _token: '{{ csrf_token() }}'
