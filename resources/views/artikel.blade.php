...
@section('content')
  <section class="section-dr-py bg-body ">
    <div class="container">
      <h3 class="text-center mb-3 mb-md-5"><span class="section-title">artikel</h3>
      <div class="row mt-5">
        <div class="col-12 col-md-4">
        <form action="{{ route('artikel') }}" method="GET">
        <div class="input-group">
            <input type="text" name="query" placeholder="Cari Artikel ...." class="form-control" value="{{ request('query') }}" />
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="card h-100 bg-label-primary text-white shadow-lg">
            <div class="card-body">
              ...
              <a href="{{ route('artikel-detail', ['slug' => $item->slug]) }}" class="btn bg-secondary w-100 text-white">Selengkapnya</a>
            </div>
          </div>
        </div>
        @endforeach
