                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            {{-- <img src="{{ asset('assets/img/avatar.jpg') }}" alt="user image"
                                ...
                                <div class="card-body">
                                    <form action="{{route('dashboard.update-photo-profile-angkatan')}}" role="form"
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('dashboard.profile_admin_angkatan') }}"><i
                                class="ti-xs ti ti-user-check me-1"></i>
                            Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('dashboard.ubah-password-angkatan') }}"><i
                                class="ti-xs ti ti-user-check me-1"></i>
                            Update Password</a>
                    </li>
                </ul>
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('dashboard.update-password-angkatan') }}">
                            @csrf
                            <div class="row">
