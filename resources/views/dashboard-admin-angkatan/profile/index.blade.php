                ...
                <div class="card mb-4">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            ...
                            <div class="card-body">
                                <form action="{{ route('dashboard.update-photo-profile-angkatan') }}" role="form" method="POST"
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('dashboard.profile_admin_angkatan') }}"><i
                                class="ti-xs ti ti-user-check me-1"></i>
                            Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard.ubah-password-angkatan') }}"><i
                                class="ti-xs ti ti-user-check me-1"></i>
                            Update Password</a>
                    </li>
                </ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data"
                            action="{{ route('dashboard.update-user-angkatan')}}">
                            @csrf
