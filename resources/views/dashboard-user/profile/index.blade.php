                ...
                <div class="card mb-4">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            ...
                            <div class="card-body">
                                <form action="{{ route('dashboard.update-photo-profile-user') }}" role="form" method="POST"
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('dashboard.profile_admin_user') }}"><i
                                class="ti-xs ti ti-user-check me-1"></i>
                            Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard.ubah-password-user') }}"><i
                                class="ti-xs ti ti-user-check me-1"></i>
                            Update Password</a>
                    </li>
                </ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <form role="form" method="POST" enctype="multipart/form-data"
                            action="{{ route('dashboard.update-user-user')}}" class="biodata-form">
                            @csrf
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-12 row w-100 mx-auto px-0">
                                    <div class="col-12 row w-100 mx-auto px-0">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group mb-3">
                                                <label for="id-city" class="form-label">Angkatan
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" name="angkatan" disabled="disabled" readonly placeholder="Bandung"
