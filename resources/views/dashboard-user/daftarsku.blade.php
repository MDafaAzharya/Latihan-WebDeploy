...
@section('content')
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Daftar Pengaju SKU </h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="w-px-400 mx-auto">
                        <form id="formAuthentication" class="mb-3" action="{{ route('pengajuan.daftar-pengajuan-user-update') }}"
                            method="POST">
                            @csrf
...
@section('page-js')
    <script type="text/javascript">
        ...
        var table = $('#table').DataTable({
            ajax: `{{ route('pengajuan.daftar-pengajuan-user-datatable') }}`,
            scrollX: true,
            // searching: true,
            paging: true,
            processing: true,
        ...
        $(document).delegate('.btn-edit', 'click', function() {
            ...
            $.ajax({
                url: "{{ url('user/daftar-pengajuan-user/daftar-pengajuan-user-edit') }}/" + id,
                type: 'get',
                data: {
                    _token: `{{ csrf_token() }}`,
                    id
